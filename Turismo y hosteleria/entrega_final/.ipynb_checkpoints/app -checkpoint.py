...
with tab_op:
    ...
    fig, ax = plt.subplots(figsize=(10, 5))
    ax.scatter(df["puntuacion"], df["precio_clp"], alpha=0.3, s=50, color="#78909C")
    ax.scatter(zona_alerta["puntuacion"], zona_alerta["precio_clp"],
               color="#D32F2F", s=70, edgecolor="black", zorder=4, label="Alertas")
    ax.axvline(x=umbral_punt, color='#C62828', linestyle='--', alpha=0.6)
