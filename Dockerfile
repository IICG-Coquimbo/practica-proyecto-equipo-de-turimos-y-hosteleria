...
# 3. Instalar librerias de Python (AGREGAR streamlit y seaborn)
RUN pip install selenium pymongo webdriver-manager "pymongo[srv]" dnspython certifi pandas streamlit seaborn
